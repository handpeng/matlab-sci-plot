...
def export_evidence(plan: Mapping[str, Any], review: Mapping[str, Any], output_dir: str | Path, *, source_data: Mapping[str, Any] | None = None, relationship_data: Mapping[str, Any] | None = None, skill_version: str = "1.3.0") -> dict[str, Any]:
